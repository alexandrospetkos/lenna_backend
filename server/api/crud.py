...
# Get the user's id from his private key
...
# Get user's query group ( an id indicating a collection of queries )
...
# Create new user query group ( an id indicating a collection of queries )
...
# Get the content of a query group ( the queries associated with the group )
...
# Create new query group content ( the queries associated with the group )
